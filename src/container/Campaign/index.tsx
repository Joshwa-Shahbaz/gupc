  ...
  return (
    <>
      <ContainerWrapper>
        ...
        <div className="relative overflow-hidden mt-[30px] pt-16 pb-32 space-y-24 lg:mt-[50px]">
          <div className="relative">
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
              <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
                <div>
                  <div>
                    <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-orange-400">
                      <svg
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-6">
                      <a
                        className="inline-flex rounded-lg bg-orange-400 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-orange-400 hover:bg-orange-700 hover:ring-orange-700"
                        href="/login"
                      >
                        Learn More
                      </a>
